...
const DeclarationOfOriginality = memo((props) => {
  ...
  return (
    <>
      <div className={styles.wrapper}>
        <h1 className={styles.cover}>Content</h1>
      </div>
      <div className={styles.wrapperButtonCover}>
        <button onClick={() => apply("Heading")} className={styles.buttonCover}>
          HEADING
        </button>
        <button className={styles.buttonCover} onClick={() => apply("SubHeading")}>
          SUBHEADING
        </button>
        <button className={styles.buttonCover} onClick={() => apply("Parangraph")}>
          PARAGRAPH
        </button>
        <button className={styles.buttonCover} onClick={() => apply("Signature/Date")}>
          SIGNATURE / DATE
        </button>
      </div>
    </>
...
export default DeclarationOfOriginality;
